...
function carregandoVoto(id){
	document.getElementById(id).innerHTML = '<td><span class="lato size30 slim">OBRIGADO PELO SEU VOTO...</span></td></table>';	
}
...
function InserirAvaliacao(nota,pg) {
	...
	// Chama requisicao	
    Requisition(id='comunicacao',url='../../includes/inserir_avaliacao.php',funcao='InserirPagina_envia',dados);
    // Atualiza avaliacao
...
function ComputarAvaliacao(pg,acao) {
	...
	//sleep(1000);
   	// Chama requisicao
    Requisition(id='avaliacao',url='../../includes/computar_avaliacao.php',funcao='InserirPagina_recebe',dados);
}
